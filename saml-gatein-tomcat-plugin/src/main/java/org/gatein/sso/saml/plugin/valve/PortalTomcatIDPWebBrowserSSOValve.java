...
/**
 * Modified version of {@link org.picketlink.identity.federation.bindings.tomcat.idp.IDPWebBrowserSSOValve} for GateIn portal purposes.
 * It is used in scenario with GateIn as SAML Identity Provider.
 *
 * @author <a href="mailto:mposolda@redhat.com">Marek Posolda</a>
 */
public class PortalTomcatIDPWebBrowserSSOValve extends IDPWebBrowserSSOValve
{

   private static final Logger log = LoggerFactory.getLogger(PortalTomcatIDPWebBrowserSSOValve.class);
